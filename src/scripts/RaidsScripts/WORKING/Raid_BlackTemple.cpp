...
public:
    ...
    GurtoggAI(Creature* pCreature) : MoonScriptCreatureAI(pCreature)
    {
		nrspells = 5;
...
public:
    ...
    ShahrazAI(Creature* pCreature) : MoonScriptCreatureAI(pCreature)
    {   
...
public:
    ...
    TeronGorefiendAI(Creature* pCreature) : MoonScriptCreatureAI(pCreature)
    {
		nrspells = 2;
		for(int i=0;i<nrspells;i++)
		{
...
public:
    ...
    ShadowyconstructsAI(Creature* pCreature) : MoonScriptCreatureAI(pCreature)
    {
...
public:
    ...
    ShadeofakamaAI(Creature* pCreature) : MoonScriptCreatureAI(pCreature)
    {
		nrspells = 1;
		for(int i=0;i<nrspells;i++)
		{
