...
class MelGrommHighmountainAI : public MoonScriptCreatureAI
{
	...
	bool m_spellcheck[7];
	MelGrommHighmountainAI(Creature* pCreature) : MoonScriptCreatureAI(pCreature) //{}
	/*
...
public:
    ...
    void OnCombatStop(Unit *mTarget)
    {
		...
		{
		//	string yell = "The attackers shall not succeed!  Strength and honor to the Horde!";
		//	_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, yell.c_str());
...
class JustiniusTheHarbingerAI : public MoonScriptCreatureAI
{
	...
	bool m_spellcheck[5];
	JustiniusTheHarbingerAI(Creature* pCreature) : MoonScriptCreatureAI(pCreature) //{}
/*
...
public:
    ...
    void OnCombatStop(Unit *mTarget)
    {
		...
		if (OCStop >= 2 && RandomUInt(2) == 1)
		{
		//	string yell = "Behold the power of the Light! Grace and glory to the Alliance!";
		//	_unit->SendChatMessage(CHAT_MSG_MONSTER_YELL, LANG_UNIVERSAL, yell.c_str());
