    ...
    uint32 ItemId;            //Item Id for reward
        ...
        CodeBoxes[2].ItemId = 4325;*/
			...
			Plr->SetOrientation(pO);
               ...
               case 466: //---------------------------------------------------------------Bat
				{
					objmgr.CreatePet(16173); return;
				}break;
				case 467: //---------------------------------------------------------------Bear
				{
					objmgr.CreatePet(7446); return;
				}break;
				case 468: //---------------------------------------------------------------Boar
				{
					objmgr.CreatePet(16117); return;
				}break;
				case 469: //---------------------------------------------------------------Carrion Bird
				{
					objmgr.CreatePet(21042); return;
				}break;
				case 470: //---------------------------------------------------------------Cat
				{
					objmgr.CreatePet(21723); return;
				}break;
				case 471: //---------------------------------------------------------------Crocolisk
				{
					objmgr.CreatePet(24047); return;
				}break;
				case 472: //---------------------------------------------------------------Dragonhawk
				{
					objmgr.CreatePet(20038); return;
				}break;
				case 473: //---------------------------------------------------------------Nether ray
				{
					objmgr.CreatePet(17731); return;
				}break;
				case 474: //---------------------------------------------------------------Owl
				{
					objmgr.CreatePet(21804); return;
				}break;
				case 475: //---------------------------------------------------------------Raptor
				{
					objmgr.CreatePet(20634); return;
				}break;
				case 476: //---------------------------------------------------------------Ravager
				{
					objmgr.CreatePet(23326); return;
				}break;
				case 477: //----------------------------------------------------------------Scorpion
				{
					objmgr.CreatePet(21864); return;
				}break;
				case 478: //----------------------------------------------------------------Tallstrider
				{
					objmgr.CreatePet(22807); return;
				}break;
				case 479: //----------------------------------------------------------------Warp Stalker
				{
					objmgr.CreatePet(23219); return;
				}break;
				case 480: //-----------------------------------------------------------------Wolf
				{
					objmgr.CreatePet(20330); return;
				}break;
				case 482: // Skoll
					{
						 objmgr.CreatePet(35189); return;
					}break;
				case 483: // Acturis
					{
						 objmgr.CreatePet(38453); return;
					}break;
				case 484: // Gondria
					{
						 objmgr.CreatePet(33776); return;
					}break;
				case 485: //Spirit Wolf
					{
						 objmgr.CreatePet(55002); return;
					}break;
				case 486: // Loque
					{
						objmgr.CreatePet(32517); return;
					}break;
