...
bool ChatHandler::HandleChangeWeather(const char * args,WorldSession * m_session)
{
	if (!*args)
        return false;
	...
	uint32 sound = (uint32)atoi(pz);                       // 0-9 sounds
