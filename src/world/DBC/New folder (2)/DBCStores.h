...
struct SpellEntry
{
	...
	uint32 AttributesExG;                                     //12 AttributesExG ?
...
struct MapEntry
{
    ...
    bool IsDynamicDifficultyMap() const { return (is_pvp_zone & MAP_FLAG_DYNAMIC_DIFFICULTY) != 0; }
};
...
enum SummonTypeId
{
    SUMMON_TYPEID_CRITTER         = 41, // CRITTER  COMPANION
    SUMMON_TYPEID_GUARDIAN        = 61,
    SUMMON_TYPEID_TOTEM_1         = 63,
    SUMMON_TYPEID_WILD            = 64,
    SUMMON_TYPEID_POSSESSED       = 65,
    SUMMON_TYPEID_DEMON           = 66,
    SUMMON_TYPEID_SUMMON          = 67,
    SUMMON_TYPEID_TOTEM_2         = 81,
    SUMMON_TYPEID_TOTEM_3         = 82,
    SUMMON_TYPEID_TOTEM_4         = 83,
    SUMMON_TYPEID_TOTEM           = 121,
    SUMMON_TYPEID_UNKNOWN3        = 181,
    SUMMON_TYPEID_UNKNOWN4        = 187,
    SUMMON_TYPEID_UNKNOWN1        = 247,
    SUMMON_TYPEID_CRITTER2        = 407,
    SUMMON_TYPEID_CRITTER3        = 307,
    SUMMON_TYPEID_UNKNOWN5        = 409,
    SUMMON_TYPEID_POSSESSED3      = 427,
    SUMMON_TYPEID_POSSESSED2      = 428,
    SUMMON_TYPEID_FORCE_OF_NATURE = 669,
    SUMMON_TYPEID_GHOUL           = 829,
    SUMMON_TYPEID_UNKNOWN12       = 881,
	SUMMON_TYPEID_LIGHTWELL       = 1341,	//  SUMMON_TYPE_GUARDIAN2  1141
    SUMMON_TYPEID_WATER_ELEMENTAL = 1561,
    SUMMON_TYPEID_UNKNOWN13       = 2301,
};
...
//extern MapDifficultyMap                          dbcMapDifficultyStore;
//extern SERVER_DECL DBCStorage<MapDifficultyEntry> sMapDifficultyMap;
...
extern SERVER_DECL DBCStorage<LiquidTypeEntry> dbcLiquidType;
...
extern SERVER_DECL DBCStorage<GameObjectDisplayInfoEntry> dbcGameObjectDisplayInfo;
