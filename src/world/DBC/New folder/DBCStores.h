...
enum SummonTypeId
{
    SUMMON_TYPE_CRITTER         = 41, // CRITTER  COMPANION
    ...
    SUMMON_TYPE_POSSESSED3      = 427,
    SUMMON_TYPE_POSSESSED2      = 428,
    SUMMON_TYPE_FORCE_OF_NATURE = 669,
    SUMMON_TYPE_GHOUL           = 829,
    SUMMON_TYPE_UNKNOWN12       = 881,
	SUMMON_TYPE_LIGHTWELL       = 1341,	//  SUMMON_TYPE_GUARDIAN2  1141
    SUMMON_TYPE_WATER_ELEMENTAL = 1561,
    SUMMON_TYPE_UNKNOWN13       = 2301,
};
