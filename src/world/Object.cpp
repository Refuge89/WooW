...
void Object::_setFaction()
{
	...
	if(IsUnit())
		factT = dbcFactionTemplate.LookupEntry(TO_UNIT(this)->GetFaction());
	else if(GetTypeId() == IsGameObject())
		factT = dbcFactionTemplate.LookupEntry(TO< GameObject* >(this)->GetFaction());
