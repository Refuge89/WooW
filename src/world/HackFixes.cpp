...
*/
	...
	sp = CheckAndReturnSpellEntry(53061);
	if(sp != NULL)
	{
		sp->Effect[0] = SPELL_EFFECT_APPLY_AURA;
		sp->EffectApplyAuraName[0] = SPELL_AURA_DUMMY;
		sp->Effect[1] = SPELL_EFFECT_APPLY_AURA;
		sp->EffectApplyAuraName[1] = SPELL_AURA_DUMMY;
		sp->DurationIndex = 32; //6000  0x20
	//	sp->DurationIndex = 589; //6500
	}
...
//***************End of Vehicles SpellFixes********************//
	...
	sp = CheckAndReturnSpellEntry(52362);
	if(sp != NULL)
	{
		sp->Effect[0] = SPELL_EFFECT_DUMMY;
	...
	sp = CheckAndReturnSpellEntry(53341);
	if(sp != NULL)
	{
		sp->Effect[1] = SPELL_EFFECT_QUEST_COMPLETE;
		sp->EffectMiscValue[1] = 12842;
	}
	sp = CheckAndReturnSpellEntry(53343);
	if(sp != NULL)
	{
		sp->Effect[1] = SPELL_EFFECT_QUEST_COMPLETE;
		sp->EffectMiscValue[1] = 12842;
