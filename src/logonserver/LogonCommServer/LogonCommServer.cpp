...
void LogonCommServerSocket::HandleMappingReply(WorldPacket & recvData)
{
    ...
    for (uint32 i = 0; i < count; ++i)
    {
        ...
        else
		{
			...
			Database_Realm->Execute("REPLACE INTO realmcharacters (numchars, acctid, realmid) VALUES (%u, %u, %u)", number_of_characters, account_id,  realm_id);
		}	
